...
//    edita con un <select> poblado con las opciones reales (optionsKey en el schema
//    traído por boardSchema.js), y se guarda con change_simple_column_value (label).
//  - 'connected': columna "conectada" (board_relation) — se edita con un <select>
...
export const COTIZAR_FIELDS = [
  ...
  { key: 'tipo', label: 'Tipo', kind: 'status', columnId: 'color_mm52vycb', optionsKey: 'tipo' },
