      ...
      <div className="quote-card__total">
        ...
        <div className="quote-card__total-actions">
          <button
            className={
              showParams
                ? 'btn btn--outline quote-card__detail-btn quote-card__params-btn--active'
                : 'btn btn--outline quote-card__detail-btn'
            }
            type="button"
          ...
          <button className="btn btn--outline quote-card__detail-btn" type="button" onClick={() => setShowDetail((v) => !v)}>
      ...
      {showParams && (
        <div className="quote-card__params">
            ...
            <>
              ...
              <div className="quote-card__params-grid">
                {PORTO_OPCIONALES.map((opt) => (
                  <label className="quote-card__params-field quote-card__params-field--checkbox" key={opt.field}>
                    <input
                      type="checkbox"
          ...
          <div className="quote-card__params-actions">
            ...
            <button className="btn btn--outline" type="button" onClick={handleApplyToCompany}>
              <MdBusiness /> Aplicar a toda {raw.compania}
            </button>
            <button className="btn btn--outline" type="button" onClick={handleReset} disabled={!hasCustomOverrides}>
              Restablecer
            </button>
          </div>
        </div>
